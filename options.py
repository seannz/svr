...
def add_argparse_args(parser):
    ...
    parser.add_argument('--positional', dest='positional', type=int, default=0, help='use positional encoded data')
    ...
    # parser.add_argument('--val_loss',  dest='val_loss', default='cce_loss', help='Loss function for training')
    parser.add_argument('--aux_loss',  dest='aux_loss', default='cce_loss', help='Loss function for training')
    ...
    parser.add_argument('--denoiser',  dest='denoiser', default='identity', help='Denoiser for self supervision')
    parser.add_argument('--postfilt',  dest='postfilt', default='identity', help='Denoiser for post-processing')
    parser.add_argument('--direct', dest='direct', action='store_true', help='direct mode filtering')
    ...
    parser.add_argument('--mu', dest='mu', type=float, default=0.1, help='semi-supervised target weight')
    parser.add_argument('--eta', dest='eta', type=float, default=0.1, help='step size for mirror descent')
    parser.add_argument('--theta', dest='theta', type=float, default=0.5, help='denoiser strength')
    parser.add_argument('--alpha', dest='alpha', type=float, default=0.999, help='denoiser strength')
    parser.add_argument('--mode', dest='mode', default='2dt', help='2dt or t2d')
    ...
    parser.add_argument('--no_dual', dest='dual_update', action='store_false', help='dual update')
    parser.add_argument('--sigma', dest='sigma', type=int, default=3, help='spatial parameter for filter')
