#!/bin/bash -x
model="flow_SNet3d0_512" # "flow_UNet2d" #"flow_UNet2d"
...
batch_size=1
load="../../checkpoints/feta3d0_4_svr_flow_SNet3d0_512_l22_loss_affine_invariant_bulktrans0_bulkrot180_trans10_rot20_250k_trans/last-v4.ckpt"
mode="--train" # --load $load --resume"
seed=0

remarks="$dataset"_"$model"_"$loss"_bulktrans0_bulkrot180_trans10_rot20_250k_trans #unmasked_pe_trans_random_zoom #_no_skip
